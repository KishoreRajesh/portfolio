    ...
    <section className='c-space section-spacing' id='about'>
        ...
        <div className='grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12'>
            <div className='flex items-end grid-default-color grid-1'>
                ...
                <div className='z-10'>
                    <p className='headtext'>Hi, I am Kishore</p>
                    <p className='subtext'>For the past 4 years, I developed my frontend skills to deliver dynamic and software and web applications. </p>
            ...
            <div ref={grid2Container} className='grid-default-color grid-2'>
                <div className='flex items-center justify-center w-full h-full'>
                    ...
                    <Card 
                    style = {{rotate: "75deg", top:"30%", left:"20%" }}text="REACT"
                    containerRef={grid2Container}
                    />
                    <Card 
                    style = {{rotate: "-30deg", top:"60%", left:"45%" }}text="JAVA"
                    containerRef={grid2Container}
                    />
                    <Card 
                    style = {{rotate: "90deg", bottom:"30%", left:"70%" }}text="DSA"
                    containerRef={grid2Container}
                    />
                    <Card 
                    style = {{rotate: "-45deg", top:"55%", left:"0%" }}text="JAVASCRIPT"
                    containerRef={grid2Container}
                    />
                    <Card 
                    style = {{rotate: "20deg", top:"10%", left:"38%" }}text="CSS"
                    containerRef={grid2Container}
                    />
                    <Card 
